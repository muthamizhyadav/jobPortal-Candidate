...
import { CandidatePlanesComponent } from './candidate/candidate-planes/candidate-planes.component';
import { MyPlanesComponent } from './candidate/my-planes/my-planes.component';
import { MyStreamsComponent } from './candidate/my-streams/my-streams.component';
import { RequestStreamsComponent } from './candidate/request-streams/request-streams.component';
...
const routes: Routes = [
  ...
  {
    path: 'empupdate-profile',
    loadChildren: () =>
      import('./employer/emp-update-profile/emp-update-profile.module').then(
        (m) => m.EmpUpdateProfileModule
      ),
  },
  {
    path: 'emp-home',
    loadChildren: () =>
      import('./employer/emp-home/emp-home.module').then(
        (m) => m.EmpHomeModule
      ),
  },
  {
    path: 'emp-postjob',
    loadChildren: () =>
      import('./employer/emp-jobpost/emp-jobpost.module').then(
        (m) => m.EmpJobpostModule
      ),
  },
  {
    path: 'emp-account',
    loadChildren: () =>
      import('./employer/emp-myaccount/emp-myaccount.module').then(
        (m) => m.EmpMyaccountModule
      ),
  },
  {
    path: 'emp-action',
    loadChildren: () =>
      import('./employer/emp-action/emp-action.module').then(
        (m) => m.EmpActionModule
      ),
  },
  {
    path: 'can-details',
    loadChildren: () =>
      import('./employer/can-details/can-details.module').then(
        (m) => m.CanDetailsModule
      ),
  },
  {
    path: 'sendMail',
    loadChildren: () =>
      import('./employer/send-mail/send-mail.module').then(
        (m) => m.SendMailModule
      ),
  },
  {
    path: 'sendJob',
    loadChildren: () =>
      import('./employer/send-job/send-job.module').then(
        (m) => m.SendJobModule
      ),
  },
  {
    path: 'emp-email-template',
    loadChildren: () =>
      import('./employer/emp-mail-template/emp-mail-template.module').then(
        (m) => m.EmpMailTemplateModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import(
        './employer/create-mail-template/create-mail-template.module'
      ).then((m) => m.CreateMailTemplateModule),
  },
  {
    path: 'job-preview',
    loadChildren: () =>
      import('./employer/job-preview/job-preview.module').then(
        (m) => m.JobPreviewModule
      ),
  },
  {
    path: 'saved-folder',
    loadChildren: () =>
      import('./employer/saved-folder/saved-folder.module').then(
        (m) => m.SavedFolderModule
      ),
  },
  {
    path: 'saved-search',
    loadChildren: () =>
      import('./employer/saved-search/saved-search.module').then(
  ...
  },
  {
    path: 'add-recruiter',
    loadChildren: () =>
      import('./employer/add-recruiter/add-recruiter.module').then(
        (m) => m.AddRecruiterModule
      ),
  },
  {
    path: 'manage-recruiter',
    loadChildren: () =>
      import('./employer/manage-recruiter/manage-recruiter.module').then(
        (m) => m.ManageRecruiterModule
      ),
  },
  {
    path: 'edit-recruiter',
    loadChildren: () =>
      import('./employer/edit-recruiter/edit-recruiter.module').then(
        (m) => m.EditRecruiterModule
      ),
  },
  {
    path: 'edit-jobpost',
  ...
  },
  {
    path: 'view-jobpost',
    loadChildren: () =>
      import('./employer/jobpost-view/jobpost-view.module').then(
        (m) => m.JobpostViewModule
      ),
  },
  ...
  { path: 'VeriftOPT', component: CanMobileverifyComponent },
  {
    path: 'updateProfile',
    loadChildren: () =>
      import('./candidate/updateprofile/updateprofile.module').then(
  ...
  },
  {
    path: 'canJobs',
    loadChildren: () =>
      import('./candidate/can-get/can-get.module').then((m) => m.CanGetModule),
  },
  {
    path: 'can-employ',
    loadChildren: () =>
      import('./candidate/emp-jobdetails/emp-jobdetails.module').then(
        (m) => m.EmpJobdetailsModule
      ),
  },
  {
    path: 'can-edu',
    loadChildren: () =>
      import('./candidate/educationdetails/educationdetails.module').then(
        (m) => m.EducationdetailsModule
      ),
  },
  {
    path: 'can-proffesinal',
    loadChildren: () =>
      import('./candidate/proffesinoal/proffesinoal.module').then(
        (m) => m.ProffesinoalModule
      ),
  },
  ...
  {
    path: 'my-stream',
    component: MyStreamsComponent,
  },
  {
    path: 'request-stream',
    component: RequestStreamsComponent,
  },
];
